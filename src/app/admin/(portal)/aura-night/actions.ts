...
export async function saveAuraSettings(formData: FormData) {
  await safeAdminAction("Aura Night settings save", ["/admin/aura-night", "/aura-night"], async () => {
...
export async function saveAuraAutomation(formData: FormData) {
  await safeAdminAction("Aura Night automation save", ["/admin/aura-night"], async () => {
    const keys = [
      "dailyReminder",
      "oneHourReminder",
...
export async function saveAuraLanding(formData: FormData) {
  await safeAdminAction("Aura Night landing save", ["/admin/aura-night", "/aura-night"], async () => {
...
export async function markAuraAttendance(bookingId: string, batchId: string | null, status: AttendanceStatus) {
  await safeAdminAction("Aura Night attendance update", ["/admin/aura-night", "/admin/dashboard"], async () => {
...
export async function cancelAuraEnrollment(bookingId: string) {
  await safeAdminAction("Aura Night enrollment cancel", ["/admin/aura-night"], async () => {
