...
export async function markAttendance(bookingId: string, batchId: string | null, status: AttendanceStatus) {
  await safeAdminAction("Booking attendance update", ["/admin/bookings", "/admin/dashboard"], async () => {
...
export async function updateBookingNotes(formData: FormData) {
  await safeAdminAction("Booking notes update", ["/admin/bookings"], async () => {
...
export async function markPaymentReceived(bookingId: string) {
  await safeAdminAction("Manual payment update", ["/admin/bookings", "/admin/dashboard"], async () => {
...
export async function updatePaymentStatus(bookingId: string, status: BookingStatus) {
  await safeAdminAction("Payment status update", ["/admin/bookings", "/admin/dashboard"], async () => {
...
export async function rescheduleBooking(formData: FormData) {
  await safeAdminAction("Booking reschedule", ["/admin/bookings", "/admin/dashboard"], async () => {
