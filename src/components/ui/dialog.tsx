...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed right-0 top-0 z-50 h-dvh w-full max-w-2xl overflow-y-auto border-l bg-background p-6 shadow-xl outline-none sm:max-w-xl",
        className
      )}
      {...props}
    >
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title ref={ref} className={cn("font-serif text-2xl font-bold", className)} {...props} />
));
